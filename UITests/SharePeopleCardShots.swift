...
final class SharePeopleCardShots: XCTestCase {
    ...
    private static let matrix: [Config] = [
        ...
        Config(name: "07-seven-2shared-expanded", people: "7,2", expand: true),
        ...
        Config(name: "20-twenty-2shared-expanded", people: "20,2", expand: true),
        Config(name: "20-twenty-2shared-search-ma", people: "20,2", expand: true, query: "ma"),
        Config(name: "20-twenty-2shared-search-none", people: "20,2", expand: true, query: "zzz"),
        ...
        Config(name: "dark-07-2shared-expanded", people: "7,2", dark: true, expand: true),
        ...
        Config(name: "ax-07-2shared-expanded", people: "7,2", ax: true, expand: true),
